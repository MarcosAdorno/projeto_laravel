    ...
    <div class="container mt-5">
        ...
        <form action="<?php echo e(route('produtos.update', $produto->id)); ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="nome" name="nome" class="form-control" value="<?php echo e($produto->nome); ?>" required>
            </div>

            <div class="mb-3">
                <label for="custo" class="form-label">Custo</label>
                <input type="number" id="custo" name="custo" class="form-control" value="<?php echo e($produto->custo); ?>" required>
            </div>

            <div class="mb-3">
                <label for="preco" class="form-label">Preço</label>
                <input type="number" id="preco" name="preco" class="form-control" value="<?php echo e($produto->preco); ?>" required>
            </div>

            <div class="mb-3">
                <label for="quantidade" class="form-label">Quantidade</label>
                <input type="number" id="quantidade" name="quantidade" class="form-control" value="<?php echo e($produto->quantidade); ?>" required>
            </div>
...
<?php /**PATH C:\Users\Marcos Adorno\Desktop\crud_basico\resources\views/produtos/edit.blade.php ENDPATH**/ ?>